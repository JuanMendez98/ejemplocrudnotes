            ...
            <div class="col-12 col-lg-6">
                ...
                <form id="enviar">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg rounded-3" id="fullname" name="fullname" required minlength="2" pattern=".*\S.*" title="Please enter your full name" placeholder="Enter your full name" autocomplete="name">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg rounded-3" id="username" name="username" placeholder="Choose a username" required minlength="3" pattern=".*\S.*" title="The username cannot be only spaces." autocomplete="username">
                    </div>
                ...
                <div class="text-center">
                    <a href="sign-in.html" class="text-secondary text-decoration-none">Already have an account? Sign in</a>
                </div>
            </div>
