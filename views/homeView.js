...
return `
    ...
    <header class="container-fluid py-3 border-bottom" id="header">
            ...
            <nav class="navbar navbar-expand-md px-0">
                ...
                <div class="collapse navbar-collapse justify-content-md-end" id="mainNavbar">
                    <ul class="navbar-nav align-items-md-center gap-2 gap-md-3 ms-auto mb-2 mb-md-0">
                        ...
                        <li class="nav-item">
                            <a href="#/login" class="btn btn-primary btn-lg rounded-pill px-4 fw-bold">Sign
                                In</a>
                        </li>
                        <li class="nav-item">
                            <a href="#/register"
    ...
    <!-- Hero Section -->
    <section id="home" class="container w-75 w-md-75 mx-auto py-5">
    ...
    <!-- Features Section -->
    <section id="contact" class="container w-75 w-md-75 mx-auto py-5 pb-0 ">
